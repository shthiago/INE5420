    ...
    def __init__(self):
        ...
        self.add_object_to_list(
            BicubicSurface('bicubic',
                         setup=BicubicSetup(
                             Point3D('_', x=0, y=0, z=0),
                             Point3D('_', x=0, y=30, z=40),
                             Point3D('_', x=0, y=60, z=30),
                             Point3D('_', x=0, y=100, z=0),
                             Point3D('_', x=30, y=25, z=20),
                             Point3D('_', x=20, y=60, z=50),
                             Point3D('_', x=30, y=80, z=50),
                             Point3D('_', x=40, y=0, z=20),
                             Point3D('_', x=60, y=30, z=20),
                             Point3D('_', x=80, y=60, z=50),
                             Point3D('_', x=70, y=100, z=45),
                             Point3D('_', x=60, y=0, z=25),
                             Point3D('_', x=100, y=-0, z=0),
                             Point3D('_', x=110, y=30, z=40),
                             Point3D('_', x=110, y=60, z=30),
                             Point3D('_', x=100, y=90, z=0)
                            ))
        )
