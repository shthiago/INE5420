...
class WireframeTab(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        # self.x_input.setGeometry(QtCore.QRect(10, 20, 41, 23))
        ...
        # self.y_input.setGeometry(QtCore.QRect(10, 40, 41, 23))
        # self.y_input.setValidator(self.numeric_validator)
        # form.addRow(QtWidgets.QLabel('Y:'), self.y_input)
        # self.z_input = QtWidgets.QLineEdit(self)
        # self.x_input.setGeometry(QtCore.QRect(10, 60, 41, 23))
